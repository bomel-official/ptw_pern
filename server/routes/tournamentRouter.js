...
router.post('/create-participant-request', AuthMiddleware, TournamentController.createParticipantRequest)
router.post('/change-participant-request-status', CheckRoleMiddleware(["ADMIN", "SUPERADMIN"]), TournamentController.changeParticipantRequestStatus)
