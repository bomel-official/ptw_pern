    ...
    return (
        <li className={`previewVertical c${columns} ${status}`}>
            <div className="previewVertical__top">
                <img src={Preview} alt="Tournament name" className="previewVertical__img"/>
            ...
            <div className="previewVertical__bottom">
                <h3 className="previewVertical__title">{__('Название турнира')}</h3>
                ...
                <div className="previewVertical__users">
                    ...
                    <span>100 / 200 {__('участников')}</span>
                </div>
                <div className="previewVertical__buttons pt32">
                    <div className="previewVertical__fund">35 000 ₽</div>
                    <NavLink to={`/tournament/${item.id}/about`} className="previewVertical__link">{__('Подробнее')}</NavLink>
                </div>
            </div>
        </li>
    )
