            ...
            <div className="tournament__content">
                ...
                <div className="tournament__sidebar-block mb48">
                    ...
                    <label htmlFor="teamAvatarImage" className="fileInput input-br mb24">
                        <span className="fileInput__text">{null ? null : __('Загрузить аватар')}</span>
                    ...
                    <button className="button-both-accent corner-margin">
                ...
                <div className="tournament__sidebar-block mb48">
                    ...
                    <label htmlFor="newpassword" className="auth__password mb12 input-both">
                        <input
                ...
                <div className="tournament__sidebar-block mb48">
                    <div className="pb12">
                        {socialItems.map((item, index) => (
                            <div className="flex mb12" key={index}>
                                ...
                                <label htmlFor="nickname" className="input-both" style={{flexGrow: 1}}>
                                    <input
                                        type="text"
                    ...
                    <button className="button-both-accent corner-margin mt">
                        <span>{__('Сохранить')}</span>
                    </button>
                </div>
            </div>
