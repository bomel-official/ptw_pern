    ...
    return (
        <div className="side__container">
            ...
            { data.participantsAmount !== 0 && <div className="build__data-block">
                ...
                <CompetitionTable data={ data.participantsUsers } setValue={ setParticipant }/>
            </div> }
            { data.isOutsiders && data.participantsAmount !== 0 && <div className="build__data-block">
                <p className="build__label">{ __( "Утешительные матчи" ) }</p>
                <CompetitionTable data={ data.outsidersUsers } setValue={ setOutsider }/>
            </div> }
            { messageOptions.text &&
            ...
            { isEdit && <div className="pt12 pb64 popup__buttons">
                ...
                { !!competition && <button className="button-both-gray corner-margin" onClick={ () => window.location.reload() }>{ __(
                    "Отменить" ) }</button> }
            </div> }
            { !isEdit && <div className="pt12 pb64 popup__buttons">
